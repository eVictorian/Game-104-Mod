...
public class Guard : MonoBehaviour
{
    ...
    private float playerTargetLevel = 2f; //player starts being tracked by the guard
    private float playerDetectedLevel = 4f; //if playerDetectionLevel reaches playerDetectedLevel the player will be spotted
